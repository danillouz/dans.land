...
![Auth0 API Quick Start values](../_assets/serverless-auth/auth0/quick-start.png)
...
![Auth0 test application API access](../_assets/serverless-auth/auth0/grant-scope-1.png)

Then check the `get:profile` scope, click "Update" and click "Continue".

![Auth0 get:profile scope selection](../_assets/serverless-auth/auth0/grant-scope-2.png)
...
![Auth0 bearer token test command](../_assets/serverless-auth/auth0/test.png)
